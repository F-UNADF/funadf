class Api::ConfigController < ApiController
    ...
    def show
        ...
        case model
            ...
            when "associations"
                # on ajoute les fields de l'association pour le form
                config[:toolbarActions] = [
                    { name: "add", title: "associations.add", icon: "mdi-plus", action: "add" },
                ]
                config[:itemActions]    = [
                    { name: "edit", title: "associations.edit", icon: "mdi-pencil", action: "edit" },
                    { name: "delete", title: "associations.delete", icon: "mdi-delete", action: "delete" },
                ]
                config[:form]           = {
                    fullscreen:  true,
                    defaultItem: Association.new,
                    tabs:        [{
                        title:  "Information générale",
                        name:   "infos",
                        fields: [
